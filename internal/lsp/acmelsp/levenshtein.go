// The code in this file is vendored in from https://github.com/agnivade/levenshtein/blob/v1.2.1/levenshtein.go to
// avoid an external dependency for a small amount of static code.
//
// It is slightly modified to not count insertions, but just replacements and deletions.
package acmelsp
...
// LevenshteinDistance computes the levenshtein distance between the two
